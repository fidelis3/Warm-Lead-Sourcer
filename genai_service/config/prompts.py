...
score_prompt = ChatPromptTemplate.from_template(
    ...
    Ensure you deeply and thorougly the provided raw data to the requirements and give a very accurate score.
